...
from .views import DriverProfileView, VehicleProfileView, DriverAcceptedTripsView, driver_profile, DriverRegistrationView, DriverLoginView, DriverRegistrationTemplateView, DriverLoginTemplateView, RequestedTripsView
